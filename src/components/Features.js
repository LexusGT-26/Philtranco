const FEATURES = [
  {
    ...
    icon: (
      <svg fill="#e31e24" viewBox="0 0 24 24" width="48" height="48">
  ...
  },
  {
    ...
    icon: (
      <svg fill="#22c55e" viewBox="0 0 24 24" width="48" height="48">
  ...
  },
  {
    ...
    icon: (
      <svg fill="#f59e0b" viewBox="0 0 24 24" width="48" height="48">
...
export default function Features() {
  return (
    <section className="relative py-20 bg-[#f3f3f3] overflow-hidden" id="features">
      ...
      <div className="max-w-[1200px] mx-auto px-5 relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
          {FEATURES.map((feature) => (
            <div
              key={feature.title}
              className="flex-1 max-w-md bg-[#f3f3f3] rounded-xl shadow-md p-8 transition-transform duration-300 hover:shadow-lg hover:-translate-y-1"
            >
